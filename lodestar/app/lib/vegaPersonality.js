...
export const VEGA_TIERS = {
  present: {
    ...
    visual: { glow: 1.0, color: theme.star, expression: "radiant", pulse: "steady" },
  ...
  gentle: {
    key: "gentle",
    dayRange: [1, 2],
    visual: { glow: 0.9, color: theme.star, expression: "attentive", pulse: "soft" },
    greetings: [
  ...
  reaching: {
    key: "reaching",
    dayRange: [3, 5],
    visual: { glow: 0.75, color: theme.star, expression: "hopeful", pulse: "lean-in" },
    greetings: [
  ...
  worried: {
    key: "worried",
    dayRange: [6, 9],
    visual: { glow: 0.55, color: theme.starDim, expression: "concerned", pulse: "uneven" },
    greetings: [
  ...
  aching: {
    key: "aching",
    dayRange: [10, 13],
    visual: { glow: 0.35, color: theme.dusk, expression: "yearning", pulse: "faint" },
    greetings: [
  ...
  meltdown: {
    ...
    visual: { glow: 0.2, color: theme.care, expression: "panicked-loving", pulse: "flicker" },
